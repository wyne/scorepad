  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" width="24" height="24">
        ...
        />
        <path
          d="M16.8 8.6 13.4 12l3.4 3.4 3.6-2.1c.8-.5.8-1.6 0-2.1l-3.6-2.6z"
          fill="#EA4335"
        />
        <path
          d="M3.6 2.3c.3-.2.7-.2 1.1 0l11.9 6.9-3.2 2.8L3.6 2.3z"
          fill="#34A853"
        />
        <path
          d="m13.4 12 3.2 2.8L4.7 21.7c-.4.2-.8.2-1.1 0L13.4 12z"
          fill="#4285F4"
        />
      </svg>
      <span>
      ...
      <div className="wrap hero-split-grid">
        <div className="hero-copy reveal in">
          ...
          <h1 className="display hero-h1">
            ...
            with your
            <br />
            <span className="hl">thumb.</span>
          </h1>
          <p className="hero-lead">
            Scorepad is the score keeper with <b>no typing</b>. Tap, swipe, or
            spin the dial to add points in any game — from family rummy to
    ...
    <header className="hero hero-board">
      ...
      <div className="wrap board-inner">
        ...
        <p className="board-lead">
          Add and subtract points with a flick. Three gestures — Tap, Swipe, and
          the all-new Dial — keep your eyes on the game, not the keyboard.
        </p>
        <StoreBadges />
      </div>
    ...
    <header className="hero hero-show">
      ...
      <div className="wrap show-inner">
        <span className="eyebrow" style={{ justifyContent: "center" }}>
          The no-typing score keeper
        </span>
        <h1 className="display show-h1">
          Every point,
          <br />
          one gesture away.
        </h1>
        <p className="show-lead">
          Tap, swipe, or spin the dial. Scorepad makes keeping score so fast it
